...
Page({
  ...
  applyGuide(guide, errorMessage) {
    ...
    this.setData({ guide, sceneTags, styleTags, isFavorited: guide.isFavorited || false, errorMessage: errorMessage || '' })
    wx.setNavigationBarTitle({ title: guide.title })
  },

  previewCover() {
    if (this.data.guide.coverImage) util.previewImages([this.data.guide.coverImage])
  },
